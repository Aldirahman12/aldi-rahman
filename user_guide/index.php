            ...
            <tbody>
              ...
              foreach($list as $l){
                ...
                <tr>
                  ...
                  <td><a href="<?=base_url('apartement/edit/'.$l->id_kamar)?>" class="btn btn-info btn-sm">Edit</a>
                    <a onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');" href="<?=base_url('apartement/delete/'.$l->id_kamar)?>" class="btn btn-danger btn-sm">Hapus</a></td>
                </tr>
                <?php $i++; 
              } ?>
            </tbody>
