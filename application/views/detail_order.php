    ...
    <div class="col-md-12" style="margin-top: 60px;">
      <div class="card">
        ...
        <div class="card-body">
          ...
          ?>
              <div class="alert alert-success" role="alert">
                ...
                <p class="mb-0">Silahkan tunjukan halaman ini kepada resepsionis  untuk hotel mendapatkan kunci kamar  anda.</p>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label class="text-purple text-bold">Nama Kamar</label>
              <p><?=$detail->nama_kamar?> - <?=$detail->fasilitas?></p>
            </div>
            <div class="form-group">
