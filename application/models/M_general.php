...
class M_General extends CI_Model{
	...
	public function gPesanan($id_pesanan){
		...
		$this->db->join('kamar','kamar.id_kamar = pesanan.id_kamar');
		$this->db->join('fasilitas','fasilitas.id_kota =kamar.id_kota');
		$this->db->join('umum','umum.id_fasilitas =hotel.id_fasilitas');
